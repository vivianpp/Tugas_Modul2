...
model_path = 'C:\Users\ASUS\Documents\Tugas_A_11795'
model = os.path.join(model_path, 'C:\Users\ASUS\Documents\Tugas_A_11795\GBT_heartDisease_model.pkl')
...
OldPeak = st.slider("Old Peak", -3.0, 7.0, step=0.1)
